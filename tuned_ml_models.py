...
def tuned_ensemble():
    model = VotingClassifier(estimators = [lin_svc(), rbf_svc(), GausProc(), light_gbc(), knn(), QDA(), naive_bayes(), RandomForrest(), NeuralNet()], weights = [ 0.14964345,  0.23744382,  0.61756679,  0.61985561,  0.7510873 , 0.04181879,  0.02666011,  1.67608676,  0.4159837 ], voting = 'soft')
    return model